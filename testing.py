...
diff = 'data/raw/bids/sub-001/dwi/sub-001_dwi.nii.gz'
bval = 'data/raw/bids/sub-001/dwi/sub-001_dwi.bval'
bvec = 'data/raw/bids/sub-001/dwi/sub-001_dwi.bvec'
    
from   nipype.interfaces.fsl import BET, ExtractROI
from src.dmri.utils import (dti_acquisition_parameters,
...
reslice(diff, new_zooms=None, order=3, out_file='')
